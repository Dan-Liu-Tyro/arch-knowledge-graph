...
11 entries, 22 supporting and 0 contradicting evidence items.
...
| Decisions are artifacts; the reasoning is the thing worth keeping | reinforced | preference | 4 | 0 | [`decisions-are-artifacts.md`](principles/decisions-are-artifacts.md) |
| Choose the least infrastructure that meets the need, and name the revisit trigger | reinforced | hypothesis | 4 | 0 | [`least-infrastructure-first.md`](principles/least-infrastructure-first.md) |
| Structure for extraction before there is a plan to extract | reinforced | hypothesis | 4 | 0 | [`structure-for-extraction.md`](principles/structure-for-extraction.md) |
